package org.rookedsysc.loan.common.handler
...
class GlobalExceptionHandler : ResponseEntityExceptionHandler() {
    ...
    fun handleCustomerAlreadyExistException(e: LoanAlreadyExistsException, webRequest: WebRequest): ResponseEntity<ErrorResponseDto> {
    ...
    fun handleResourceNotFoundException(e: LoanAlreadyExistsException, webRequest: WebRequest): ResponseEntity<ErrorResponseDto> {
